	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top" style="height:60px">
			<div class="navbar-inner" style="height:60px;background-size:1200px 60px;background-image:url('${ctxStatic}/images/nplogo4.png');">
				...
				<!-- 增加style="display: none;"，隐藏菜单	modify by hechungui on 20160220 -->
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2016-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://www.supermap.com" target="_blank">SuperMap</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
